...
Structural-reference variance: {'repeated': False, 'codes': {'VALIDATION_FAILED': 1, 'MALFORMED_VERSE_REFERENCE': 1}}. The next wave remains pending execution and human authorization; no repeated structural-reference variance was observed. No malformed response was repaired or rerendered.
