...
# The Docker build generates a seeded lexical database from pinned source
# revisions. At runtime the entrypoint copies it into the mounted .bhf volume
# if no runtime lexical database exists there.
...
RUN chmod +x /app/scripts/docker-entrypoint.sh \
    ...
    && mkdir -p /tmp/bhf-lexical-sources /app/.bhf-seed \
