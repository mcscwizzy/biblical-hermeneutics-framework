...
class WebAssetTests(unittest.TestCase):
    ...
    def test_reader_tabs_render_side_by_side_panes_with_independent_scroll(self):
        ...
        self.assertNotIn("syncReaderPaneScroll", script)
        self.assertNotIn("wireReaderPaneScrollSync", script)
    ...
    def test_reader_mode_uses_browser_native_verse_speech_with_cleanup(self):
        ...
        self.assertNotIn("createWorldTerrain", map_script)
        self.assertNotIn("Terrain.fromWorldTerrain", map_script)
        self.assertNotIn("PLAYBACK_SPEEDS", map_script)
        self.assertNotIn("currentStopIndex", map_script)
        self.assertNotIn("isPlaying", map_script)
        ...
        index_html = Path("bhf_web/templates/index.html").read_text(encoding="utf-8")
        self.assertNotIn("window.BHFCesiumIonToken =", index_html)
        ...
        self.assertNotIn("journey-modal", index_html)
        self.assertNotIn("journey-panel-modal-host", index_html)
...
class WebAppTests(unittest.TestCase):
    ...
    def test_get_index_returns_200(self):
        ...
        self.assertNotIn("data-context-submenu=\"context\"", response["body"])
        self.assertNotIn("data-context-submenu=\"reference\"", response["body"])
        self.assertNotIn("data-context-submenu=\"actions\"", response["body"])
        self.assertIn('aria-label="Study menu"', response["body"])
        ...
        self.assertIn("app-dock-archaeology", response["body"])
        self.assertNotIn("explore-archaeology", response["body"])
        self.assertLess(
        ...
        self.assertIn("Search the canonical library to see results.", response["body"])
        self.assertIn("Search for a person, place, theme, Scripture, or object ID.", response["body"])
        self.assertNotIn("Showing 12 canonical objects from the browse catalog.", response["body"])
    ...
    def test_offline_browser_assets_are_wired(self):
        ...
        self.assertIn("applyOnlineMutationResponse", offline_db["body"])
        ...
        self.assertIn("clearRebuildableOfflineData(button)", pwa_script["body"])
        self.assertIn("Update available", pwa_script["body"])
        self.assertIn("setPwaUpdateAvailable", pwa_script["body"])
        self.assertIn("device-imported translations", pwa_script["body"])
