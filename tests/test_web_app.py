...
class WebAssetTests(unittest.TestCase):
    ...
    def test_reader_script_has_context_menu_and_highlight_actions(self):
        ...
        self.assertIn("PLAYBACK_SPEEDS", journey_script)
        self.assertIn("journeySearch", journey_script)
        self.assertIn("renderJourneyLibraryFilters", journey_script)
        self.assertIn("currentStopIndex", journey_script)
        self.assertIn("isPlaying", journey_script)
        self.assertIn("activeSegmentId", journey_script)
        ...
        self.assertIn("playPlayback", journey_script)
        self.assertIn("restartPlayback", journey_script)
        self.assertIn("schedulePlaybackAdvance", journey_script)
        ...
        self.assertIn("data-journey-playback-play", journey_script)
        self.assertIn("data-journey-playback-label", journey_script)
        ...
        self.assertIn("data-journey-playback-play", index_html)
        self.assertIn("data-journey-playback-speed", index_html)
        self.assertIn("data-journey-playback-label", index_html)
    ...
    def test_map_styles_cover_entity_icons_and_mobile_panel_layout(self):
        ...
        self.assertIn(".journey-playback-card", style)
        self.assertIn(".journey-progress-track", style)
        self.assertIn(".journey-progress-value", style)
