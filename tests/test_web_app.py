...
class WebAssetTests(unittest.TestCase):
    ...
    def test_reader_script_has_context_menu_and_highlight_actions(self):
        ...
        self.assertIn("setReferenceLayerVisibility", map_script)
        ...
        self.assertIn("data-map-reference-layer-controls", map_script)
        ...
        self.assertIn("feature.summary || feature.description", map_script)
        ...
        self.assertIn("data-map-reference-layer-controls", index_html)
...
class WebAppTests(unittest.TestCase):
    ...
    def test_get_index_returns_200(self):
        ...
        self.assertIn("data-map-reference-layer-controls", response["body"])
