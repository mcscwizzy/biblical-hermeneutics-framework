...
class WebAssetTests(unittest.TestCase):
    ...
    def test_reader_script_persists_and_restores_last_local_location(self):
        ...
        self.assertIn("data-map-journey-selector", map_script)
        self.assertIn("Journey controls stay compact beside search", map_script)
        ...
        self.assertIn("data-map-journey-toggle", index_html)
        self.assertIn("map-search-row--journey", index_html)
...
class WebAppTests(unittest.TestCase):
    ...
    def test_get_index_returns_200(self):
        ...
        self.assertIn("data-map-journey-toggle", response["body"])
