...
def result_metadata(result: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "Configured model": metadata.get("configured_model") or "not available",
        "Selected model": metadata.get("model") or "not available",
        "Provider": metadata.get("provider") or "not available",
        "Provider routing diagnostics": metadata.get("provider_diagnostics") or "none",
