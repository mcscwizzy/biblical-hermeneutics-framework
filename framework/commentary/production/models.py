...
ALLOWED_TRANSITIONS: dict[str, frozenset[str]] = {
    PENDING: frozenset({READY, APPLICATION_FALLBACK, GENERATING, STALE_INPUT, BLOCKED}),
    READY: frozenset({APPLICATION_FALLBACK, GENERATING, STALE_INPUT, BLOCKED}),
    APPLICATION_FALLBACK: frozenset({VALIDATING, QUARANTINED, BLOCKED}),
